...
class Skins {
  ...
  static const List<CoreSkin> all = [
    ...
    CoreSkin('EMBER', Color(0xFFFFB45C), Color(0xFFFF6B2E), 400),
    CoreSkin('TOXIC', Color(0xFFC6FF4D), Color(0xFF8BFF00), 680),
    CoreSkin('NOVA', Color(0xFFFF6FD8), Color(0xFFFF2EC4), 980),
    CoreSkin('PULSE', Color(0xFF6EE7FF), Color(0xFF00B4FF), 1280),
    CoreSkin('FROST', Color(0xFFD6FBFF), Color(0xFF8AD8FF), 1650),
    CoreSkin('AURUM', Color(0xFFFFE36E), Color(0xFFFFC400), 2200),
